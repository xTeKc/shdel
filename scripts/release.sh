...
# [GitHub](https://github.com/xTeKc/shdel/releases) and [crates.io](https://crates.io/crates/shdel) releases are automated via [GitHub actions](.github/workflows/cd.yml) and triggered by pushing a tag.
...
# 3. Check if [Continuous Integration](https://github.com/xTeKc/shdel/actions) workflow is completed successfully.
# 4. Push the tags: `git push --tags` or a specific tag `git push origin v<tag_num>`
# 5. Wait for [Continuous Deployment](https://github.com/xTeKc/shdel/actions) workflow to finish.
